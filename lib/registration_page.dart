  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      body: Center(
        child: Column(
          children: [
            Text("Register for the Open Day!", style: TextStyle(fontFamily: 'RobotoSlab', fontWeight: FontWeight.w600, fontSize: 24),),
            Padding(
              padding: EdgeInsets.all(15.0),
              child: Text("Register here for your open day. This is entirely optional but does allow us to keep you updated with the latest developments and information for our courses", style: TextStyle(fontFamily: 'Roboto', fontSize: 14, fontWeight: FontWeight.w400),),
            ),
            SizedBox( height: 20 ),
            Form(
              key: _formKey,
